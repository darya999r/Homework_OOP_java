public class Daughter extends Person implements MotherInterface, FatherInterface{
    private Integer motherId;
    private Integer fatherId;
    private Integer brotherId;
    private Integer sisterId;

    public Daughter(int id, String name, String surname, String patronymic, int age, String social_status, 
    ...
    public void slimness() {
        System.out.println("\tSlimness = 90%"); 
    }

    @Override
    public void thick_eyebrows() {
        System.out.println("\tThick eyebrows = 40%");
    }

    @Override
    public void growth() {
        System.out.println("\tGrowth = 175cm");
    }
}
